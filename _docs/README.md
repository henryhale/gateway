...
This guide covers building a gateway: defining standard payloads,
...
before/after mapping; the previous release documentation remains at the
[`v0.1.0` tag](https://github.com/henryhale/gateway/blob/v0.1.0/docs/index.md).
